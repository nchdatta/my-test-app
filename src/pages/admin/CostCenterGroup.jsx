...
import CostCenterGroupDialog from '../../components/Dialogs/CostCenterGroupDialog';
...
const CostCenterGroup = () => {
    ...
    return (
        <Page title='Manage Cost-Center Groups'>
            <PageHeader
                title="Manage Cost-Center Groups"
                btnText="Add New"
                handleBtn={() => {
                    setRowData(null);
                    setAddNewDialog(true);
                }}
                currentPage="Manage Cost-Center Groups" />
            ...
            {addNewDialog && <CostCenterGroupDialog setOpenDialog={setAddNewDialog} openDialog={addNewDialog} metadata={{ id: rowData?.id }} />}
        </Page>
    );
};

export default CostCenterGroup;