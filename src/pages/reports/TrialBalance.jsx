    ...
    return (
        <Page title='Trial Balance Report'>
            <PageHeader
                ...
                currentPage="Trial Balance Report" />
                            ...
                            <Table size="medium" sx={{ minWidth: 650 }} aria-label="simple table">
                                <TableHead>
                                    <TableRow sx={{ bgcolor: grey[100] }}>
                                        ...
                                        <TableCell align="left" width={300} sx={{ fontWeight: "bold" }}>Account Code</TableCell>
                                ...
                                <TableBody>
                                    {accountReportData?.map((row, index) => (
                                        <TableRow key={index} hover>
                                            ...
                                            <TableCell align="left" width={300}>{"101010001"}</TableCell>
