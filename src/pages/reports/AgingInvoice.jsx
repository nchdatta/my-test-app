...
const AgingInvoice = () => {
    ...
    return (
        <Page title='Aging Invoice Report'>
            <PageHeader
                btn={false}
                title="Aging Invoice Report"
                currentPage="Aging Invoice Report" />
                            ...
                            <Table size="medium" sx={{ minWidth: 650 }} aria-label="simple table">
                                <TableHead>
                                    <TableRow sx={{ bgcolor: grey[100] }}>
                                        ...
                                        <TableCell align="left" width={300} sx={{ fontWeight: "bold" }}>Net Amount</TableCell>
                                        <TableCell align="center" sx={{ fontWeight: "bold" }}>1-30</TableCell>
                                        <TableCell align="center" sx={{ fontWeight: "bold" }}>31-60</TableCell>
                                        <TableCell align="center" sx={{ fontWeight: "bold" }}>61-90</TableCell>
                                        <TableCell align="center" sx={{ fontWeight: "bold" }}>91-Above</TableCell>
                                        <TableCell align="center" sx={{ fontWeight: "bold" }}>Rest Amount</TableCell>
                                    </TableRow>
                                </TableHead>
                                <TableBody>
                                    {accountReportData?.map((row, index) => (
                                        <TableRow key={index} hover>
                                            ...
                                            <TableCell align="left" width={300}>{1000}</TableCell>
