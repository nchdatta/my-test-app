...
const PartyLedger = () => {
    ...
    return (
        <Page title='Party Ledger Report'>
            <PageHeader
                btn={false}
                title="Party Ledger Report"
                currentPage="Party Ledger Report" />
                ...
                <form onSubmit={handleSubmit(onSubmit)}>
                    <Grid container spacing={1.5} justifyContent={"flex-end"}>
                        ...
                        <Grid item xs={6} md={"auto"}>
                            <Button variant="outlined" disabled={loading} type="submit" color="primary" size='large'>
                            ...
                            <Table size="medium" sx={{ minWidth: 650 }} aria-label="simple table">
                                <TableHead>
                                    <TableRow sx={{ bgcolor: grey[100] }}>
                                        ...
                                        <TableCell align="left" sx={{ fontWeight: "bold" }}>Voucher No.</TableCell>
                                ...
                                <TableBody>
                                    {accountReportData?.map((row, index) => (
                                        <TableRow key={index} hover>
                                            ...
                                            <TableCell align="left">{"08 May 2023"}</TableCell>
                                            <TableCell align="left">{"JV10112300001"}</TableCell>
                                            <TableCell align="center">{"Opening"}</TableCell>
                                            <TableCell align="center">{"74403"}</TableCell>
