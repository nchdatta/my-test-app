...
const CostCenterSummary = () => {
    ...
    return (
        <Page title='Cost Center Summary Report'>
            <PageHeader
                btn={false}
                title="Cost Center Summary Report"
                currentPage="Cost Center Summary Report" />
                            ...
                            <Table size="medium" sx={{ minWidth: 650 }} aria-label="simple table">
                                <TableHead>
                                    <TableRow sx={{ bgcolor: grey[100] }}>
                                        ...
                                        <TableCell align="left" width={300} sx={{ fontWeight: "bold" }}>Cost Center Name</TableCell>
                                ...
                                <TableBody>
                                    {accountReportData?.map((row, index) => (
                                        <TableRow key={index} hover>
                                            ...
                                            <TableCell align="left" width={300}>{"Human Resource"}</TableCell>
