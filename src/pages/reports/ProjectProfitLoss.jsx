...
const ProjectProfitLoss = () => {
    ...
    return (
        <Page title='Project wise Profit/ Loss Report'>
            <PageHeader
                btn={false}
                title="Project wise Profit/ Loss Report"
                currentPage="Project wise Profit/ Loss Report" />
                            ...
                            <Table size="medium" sx={{ minWidth: 650 }} aria-label="simple table">
                                <TableHead>
                                    <TableRow sx={{ bgcolor: grey[100] }}>
                                        ...
                                        <TableCell align="left" sx={{ fontWeight: "bold" }}>Party Name</TableCell>
                                        <TableCell align="left" sx={{ fontWeight: "bold" }}>Project Name</TableCell>
                                        <TableCell align="center" sx={{ fontWeight: "bold" }}>Total Revenues</TableCell>
                                        <TableCell align="center" sx={{ fontWeight: "bold" }}>Total Revenues</TableCell>
                                        <TableCell align="center" sx={{ fontWeight: "bold" }}>Total Profits</TableCell>
                                        <TableCell align="center" sx={{ fontWeight: "bold" }}>Total Losses</TableCell>
                                    </TableRow>
                                </TableHead>
                                <TableBody>
                                    {accountReportData?.map((row, index) => (
                                        <TableRow key={index} hover>
                                            ...
                                            <TableCell align="left">{"Airport-APM Global Logistic Ltd"}</TableCell>
                                            <TableCell align="center">{56634}</TableCell>
                                            <TableCell align="center">{5000}</TableCell>
                                            <TableCell align="center">{51634}</TableCell>
