...
const AllLedger = () => {
    ...
    return (
        <Page title='All Ledger Reports'>
            <PageHeader
                btn={false}
                title="All Ledger Reports"
                currentPage="All Ledger Reports" />
                            ...
                            <Table size="medium" sx={{ minWidth: 650 }} aria-label="simple table">
                                <TableHead>
                                    <TableRow sx={{ bgcolor: grey[100] }}>
                                        ...
                                        <TableCell align="left" width={300} sx={{ fontWeight: "bold" }}>Date</TableCell>
                                        <TableCell align="left" width={300} sx={{ fontWeight: "bold" }}>Voucher No.</TableCell>
                                        <TableCell align="center" sx={{ fontWeight: "bold" }}>Party Name</TableCell>
                                        <TableCell align="center" sx={{ fontWeight: "bold" }}>Cheque No</TableCell>
                                        <TableCell align="center" sx={{ fontWeight: "bold" }}>Debit</TableCell>
                                        <TableCell align="center" sx={{ fontWeight: "bold" }}>Credit</TableCell>
                                        <TableCell align="center" sx={{ fontWeight: "bold" }}>Narration</TableCell>
                                    </TableRow>
                                </TableHead>
                                <TableBody>
                                    {accountReportData?.map((row, index) => (
                                        <TableRow key={index} hover>
                                            ...
                                            <TableCell align="left" width={300}>{"12/08/23"}</TableCell>
                                            <TableCell align="left" width={300}>{row?.account_name}</TableCell>
                                            <TableCell align="center">{"CH001522350"}</TableCell>
