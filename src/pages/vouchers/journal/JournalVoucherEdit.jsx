...
const JournalVoucherEdit = () => {
    ...
    return (
        <Page title='Edit Journal Voucher'>
            <PageHeader title="Edit Journal Voucher" btn={false}
                breadcrumbLinks={[
                    { label: "Manage Journal Vouchers", href: '/vouchers/journal/manage' }
                ]}
                currentPage="Edit Journal Voucher" />
