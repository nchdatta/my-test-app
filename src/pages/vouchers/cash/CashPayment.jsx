...
const CashPayment = () => {
    ...
    return (
        <Page title='Cash Payment Manage'>
            <PageHeader
                title="Cash Payment Manage"
                btnText="Add New"
                navigate='/vouchers/cash-payment/add'
                currentPage="Cash Payment Manage" />
            ...
            <ActionMenu
                ...
                editUrl={`/vouchers/cash-payment//edit/${rowData?.id}`}
