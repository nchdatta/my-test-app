...
const CashReceive = () => {
    ...
    return (
        <Page title='Cash Receive Manage'>
            <PageHeader
                title="Cash Receive Manage"
                btnText="Add New"
                navigate='/vouchers/cash-receive/add'
                currentPage="Cash Receive Manage" />
            ...
            <ActionMenu
                ...
                editUrl={`/vouchers/cash-receive//edit/${rowData?.id}`}
