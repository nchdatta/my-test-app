...
const ContraVoucher = () => {
    ...
    return (
        <Page title='Manage Contra Vouchers'>
            <PageHeader
                title="Manage Contra Vouchers"
                btnText="Add New"
                navigate='/vouchers/contra-voucher/add'
                currentPage="Manage Contra Vouchers" />
            ...
            <ActionMenu
                ...
                editUrl={`/vouchers/contra-voucher/edit/${rowData?.id}`}
