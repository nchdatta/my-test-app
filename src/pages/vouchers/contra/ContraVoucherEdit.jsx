...
const ContraVoucherEdit = () => {
    ...
    return (
        <Page title='Edit Contra Voucher'>
            <PageHeader title="Edit Contra Voucher" btn={false}
                breadcrumbLinks={[
                    { label: "Manage Contra Vouchers", href: '/vouchers/contra/manage' }
                ]}
                currentPage="Edit Contra Voucher" />
...
export default ContraVoucherEdit;