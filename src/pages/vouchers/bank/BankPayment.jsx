...
const BankPayment = () => {
    ...
    return (
        <Page title='Bank Payments Manage'>
            <PageHeader
                title="Bank Payments Manage"
                btnText="Add New"
                navigate='/vouchers/bank-payment/add'
                currentPage="Bank Payments Manage" />
            ...
            <ActionMenu
                ...
                editUrl={`/vouchers/bank-payment/edit/${rowData?.id}`}
