...
import COAGroupDialog from '../../../components/Dialogs/COAGroupDialog';
...
const Group = () => {
    ...
    return (
        <Page title='COA Group Management'>
            <PageHeader
                title="COA Group Management"
                btnText="Add New"
                handleBtn={() => {
                    setRowData(null);
                    setAddNewDialog(true);
                }}
                currentPage="COA Group Management" />
                ...
                <Table size="medium" sx={{ minWidth: 650, minHeight: '70vh' }} aria-label="simple table">
                    <TableHead>
                        <TableRow sx={{ bgcolor: grey[100] }}>
                            ...
                            <TableCell align="left" sx={{ fontWeight: "bold" }}>Group Code</TableCell>
                    ...
                    <TableBody>
                        {financialYearsData.map((row, index) => (
                            <TableRow key={index}>
                                ...
                                <TableCell align="left">{101}</TableCell>
            ...
            {addNewDialog && <COAGroupDialog setOpenDialog={setAddNewDialog} openDialog={addNewDialog} metadata={{ id: rowData?.id }} />}
            {viewModal && <ViewCOAGroupModal
                setOpenModal={setViewModal}
                openModal={viewModal}
                metadata={{ title: 'COA Group Information', data: rowData }} >
                <VRow data={[
                    { label: "Group Code", value: 101 },
                    { label: "Group Name", value: "Current Asset" },
                    { label: "Category Name", value: "Property & Assets" },
                    { label: "Added on", value: "12/05/2023" },
