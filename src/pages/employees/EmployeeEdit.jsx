...
const EmployeeEdit = () => {
    ...
    return (
        <Page title={`Edit Employee Information - ${"Nayan Datta"}`}>
            <PageHeader title="Edit Employee Information" subTitle="Nayan Datta" btn={false}
                breadcrumbLinks={[
                    { label: "Manage Employees", href: '/employees/manage' }
                ]}
                currentPage="Edit Employee Information" />
